    ...
    return vscode.commands.registerCommand('liana.initialize_liana_authoring_environment', async () => {
        try {
            ...
            if (existingFiles.length > 0) {
                const overwrite = await vscode.window.showWarningMessage('Target directory is not empty. Copy template files anyway?', 'Yes', 'No');
                if (overwrite !== 'Yes') {
                    return;
                }
            }
...
//# sourceMappingURL=initialize_liana_authoring_environment.js.map